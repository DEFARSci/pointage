...
<nav class="navbar navbar-expand-lg navbar-light " style="background: linear-gradient(to right,#84addb , #84addb );">
...
<nav class="navbar navbar-expand-lg navbar-light " >
  ...
  <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
   ...
   <div class="navbar-nav p-3">
     ...
     <a class="nav-link " href="/register" style="color:#84addb;">Register</a>
     @endif
    </div>
    @endauth
        <div class="navbar-nav p-3">
          ...
          <a class="nav-link " href="/login" style="color:#84addb;">Login</a>
          @endguest
